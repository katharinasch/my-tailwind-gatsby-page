        ...
        <div className="md:flex items-center justify-between py-4 md:py-8 border-t border-gray-200 content-center">
          ...
          <div className="mx-auto">
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              <li className="ml-4">
                  <a href='https://api.whatsapp.com/send?phone=4917631482430&text=Hallo!' target="_blank"  rel="noreferrer" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Github">
              ...
              <li className="ml-4">
                <a href="https://www.linkedin.com/in/katharina-schreiber-49838a27" target="_blank"  rel="noreferrer" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Github">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
